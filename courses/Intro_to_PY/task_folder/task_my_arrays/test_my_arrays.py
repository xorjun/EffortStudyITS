...
def test_my_arrays():
    ...
    assert my_arrays(-3) is None, "The function does not return None for negative integers. Please account for this case!"
    assert my_arrays(0) is None, "The function does not return None for zero. Please account for this case!"
