...
Numpy is a rich library with a variety of in-built functions. In particular, trigonometric functions. 
...
(**HINT** as you can see  in the example above, trigonometric functions take the values in radians. To convert angles to radians, **np.pi** can be quite helpful.)