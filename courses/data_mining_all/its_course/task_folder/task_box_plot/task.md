...
In a shared plot, create four box plots using the function `matplotlib.pyplot.boxplot`, one for each array. Make sure the box plots and the y-axis are labeled.